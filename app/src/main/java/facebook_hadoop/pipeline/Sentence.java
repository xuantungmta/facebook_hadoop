...
public class Sentence {
    ...
    public Sentence(String rawSentence, WordSegmenter wordSegmenter, PosTagger tagger, NerRecognizer nerRecognizer,
            DependencyParser dependencyParser) throws IOException {
    ...
    private void init(String rawSentence) throws IOException {
        ...
        if (this.wordSegmenter != null) {
            ...
            this.wordSegmentedSentence = String.join(" ", this.tokens);
